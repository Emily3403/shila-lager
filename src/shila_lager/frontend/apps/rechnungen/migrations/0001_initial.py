    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('Lastschrift', 'Lastschrift'), ('LS Wiedergutschrift', 'Lastschrift Undo'), ('Dauerauftrag', 'Dauerauftrag'), ('Rechnung', 'Rechnung'), ('Kartenzahlung', 'Kartenzahlung'), ('Online-Uberweisung', 'Onlineuberweisung'), ('Gutschrift', 'Gutschrift'), ('Bargeldeinzahlung', 'Bargeldeinzahlung'), ('Abschluss', 'Abschluss'), ('Entgeldabschluss', 'Entgeltabschluss')], max_length=64)),
                ...
                ('beneficiary_or_payer', models.CharField(choices=[('GRIHED Service GmbH', 'Grihed'), ('Team Getränke', 'Team Getränke'), ('GEPA MBH', 'Gepa'), ('DM-drogerie markt', 'Dm'), ('Hetzner Online GmbH', 'Hetzner'), ('Berliner Sparkasse', 'Sparkasse'), ('TU Berlin', 'Tu Berlin'), ('VPSL', 'Vpsl'), ('Emily Seebeck', 'Emily'), ('Leander Guelland', 'Lelle'), ('Ilja Behnke', 'Ille'), ('Jonas Pasche', 'Jonas'), ('Jette Eckel', 'Jette'), ('Helge Kling', 'Helge'), ('Fabian Ruben', 'Fabian'), ('Elias Tretin', 'Elias'), ('Andere Personen', 'Andere Personen'), ('Sonstiges', 'Sonstiges')], max_length=64, null=True)),
        ...
        migrations.CreateModel(
            name='ShilaInventoryCount',
            fields=[
                ('date', models.DateTimeField(primary_key=True, serialize=False)),
                ('other_monetary_value', models.DecimalField(decimal_places=2, max_digits=16)),
                ('money_in_safe', models.DecimalField(decimal_places=2, max_digits=16)),
                ('extra_expenses', models.JSONField()),
            ],
            options={
        ...
        migrations.CreateModel(
            name='ShilaInventoryCountDetail',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('count', models.DecimalField(decimal_places=4, max_digits=16)),
                ('crate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bestellung.beveragecrate')),
                ('date', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='details', to='rechnungen.shilainventorycount')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='shilainventorycount',
            name='crates',
            field=models.ManyToManyField(related_name='inventory_counts', through='rechnungen.ShilaInventoryCountDetail', to='bestellung.beveragecrate'),
        ),
        migrations.CreateModel(
